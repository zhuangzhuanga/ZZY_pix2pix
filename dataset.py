...
class DeblurDataset(Dataset):
    def __init__(self, root_dir):
        ...
        self.files_list = os.listdir(os.path.join(self.root_dir, "raw/"))
    ...
    def __getitem__(self, index):
        ...
        inp_img_path = os.path.join(os.path.join(self.root_dir, "raw/"), img_file)
        tar_img_path = os.path.join(os.path.join(self.root_dir, "modify/"), img_file)
